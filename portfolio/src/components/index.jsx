  ...
  return (
    <Grid className="section">
      ...
      <Grid item xs={12}>
        ...
        <p></p>
        <p>My name is Ryan Santiago. I am a former technical support specialist at AT&T. I've achieved a great amount of success in my career, even gotten as far as running an entire store and taking lead on some amazing business deals. I've always been very passionate about what I do. But solving problems have been one of my biggest motivators!</p>
        </Typography>
      </Grid>
      <Grid item className='grid_title mb-30' xs={12}>
        <span></span>
